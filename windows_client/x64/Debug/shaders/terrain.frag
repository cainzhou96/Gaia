...
uniform vec3 Ka = vec3(0.533333, 0.653333, 0.693333); //! color[0.7, 0.7, 0.7]
uniform vec3 Kd = vec3(1.0, 1.0, 1.0); //! color[(0.9, 0.8, 1.0]
uniform vec3 Ks = vec3(0.7, 0.7, 0.7); //! color[0.7, 0.7, 0.7]
...
uniform int colorSteps = 10; //! slider[1, 5, 10]
